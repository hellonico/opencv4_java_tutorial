...
public class detectContours {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Mat img1 = Imgcodecs.imread("files/cctv_example1.png");
        Mat img2 = Imgcodecs.imread("files/cctv_example2.png");
        ...
        Imgproc.adaptiveThreshold(grey, diff_img, 255, Imgproc.ADAPTIVE_THRESH_MEAN_C, Imgproc.THRESH_BINARY_INV, 7,
                10);
