...
public class TensorflowDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<String> labels = Files.readAllLines(Paths.get("data/tf/imagenet_slim_labels.txt"));
        System.out.println(labels.get((int) minmax.maxLoc.x));

        // check scores
        Mat top5RefScores = new MatOfFloat(0.63032645f, 0.2561979f, 0.032181446f, 0.015721032f, 0.014785315f).reshape(1,
                1);
