...
class DiscreteFourierTransformRun {
    private void help() {
        System.out.println("" + "This program demonstrated the use of the discrete Fourier transform (DFT). \n"
                + "The dft of an image is taken and it's power spectrum is displayed.\n" + "Usage:\n"
                + "./opencvtutorial.DiscreteFourierTransform [image_name -- default ../data/lena.jpg]");
    }
    ...
    public void run(String[] args) {
        ...
        Core.normalize(magI, magI, 0, 255, Core.NORM_MINMAX, CvType.CV_8UC1); // Transform the matrix with float values
                                                                              // into a viewable image form (float
                                                                              // between
                                                                              // values 0 and 255).
        // ! [normalize]
