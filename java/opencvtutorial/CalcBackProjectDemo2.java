...
class CalcBackProject2 {
    ...
    private void update(int x, int y) {
        ...
        Imgproc.floodFill(src, mask2, seed, newVal, new Rect(), new Scalar(low, low, low), new Scalar(up, up, up),
                flags);
        ...
        Imgproc.calcHist(hsvList, new MatOfInt(channels), mask, hist, new MatOfInt(histSize), new MatOfFloat(ranges),
                false);
