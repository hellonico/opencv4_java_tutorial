...
public class DnnOpenCV {
    ...
    private static final String IMAGENET_CLASSES = "data/sallick/imagenet_classes.txt";
    private static final String MODEL_PATH = "data/sallick/mobilenetv2-7.onnx";
